                            ...
                            <form id="editForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-lg-12 mb-3">
                                        <label class="form-label">دسته بندی sku ها</label>
                                        <Multiselect
                                            v-model="value"
                                            :mode="'tags'"
                                            :options="categories"
...
export default {
    ...
    methods: {
        ...
        loadCategories() {
             axios.get('/api/panel/category/sku?page=1&perPage=100000')
                .then((response) => {
