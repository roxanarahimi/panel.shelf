<template>
    <transition name="route" mode="out-in" appear>
        <section class="" style="text-align: justify">
            <div class="row " v-if="data.id">
                    ...
                    <div class="row px-3 ">
                        <div class="col-12 mb-3 ">
                            <div class="d-inline-block mt-5">
                                <h3 class="mb-2 fw-bold d-block">{{ 'محله '+data.title }}</h3>
                            </div>
                            <router-link :to="'/panel/edit/sector/'+data.id" class="text-dark">
                <span title="ویرایش محله"
                ...
                <div class="row">
                    <div class="col-xxl-12 mb-5 ">
                        ...
                        <ul>
                            <li v-for="item in data.customers"><router-link :to="'/panel/customer/'+item.id">{{ item.title }}</router-link></li>
                        </ul>
            ...
            <div v-else><p class="fw-bold">این محله موجود نیست</p></div>
...
export default {
    ...
    methods: {
        async loadSector() {
            ...
            await axios.get('/api/panel/sector/' + this.id)
                .then((response) => {
