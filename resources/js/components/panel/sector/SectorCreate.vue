<template>
    <transition name="route" mode="out-in" appear>
        <section>
            <h3 class="mb-5">ثبت محله جدید</h3>
                            ...
                            <form id="editForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-4 mb-3">
                                        ...
                                        <select v-model="selectedCity" class="form-select" id="city_id" aria-describedby="cityHelp"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" :class="{hasError: errors.score}" class="form-control"
                                               id="score" aria-describedby="scoreHelp" required>
    ...
    methods: {
        ...
        async createInfo() {
            ...
            if (emptyFieldsCount === 0) {
                await axios.post('/api/panel/sector', {
                    ...
                    .then((response) => {
                        ...
                        if (response.status === 201 || response.status === 200) {
                            setTimeout(() => {
                                this.$router.push({path: '/panel/sectors'});
                            }, 1000);
