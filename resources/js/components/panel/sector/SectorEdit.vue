            ...
            axios.get('/api/panel/province?page=1&perPage=1000&search=')
                ...
                .then(()=>{
                   setTimeout(()=>{
                       ...
                       console.log('ssss',this.selectedProvince)
                   },200)
                })
                .catch()
        },
                ...
                axios.post('/api/panel/sector/' + this.$route.params.id,
                    ...
                    .then((response) => {
                        ...
                        if (response.status === 200) {
                            setTimeout(() => {
                                this.$router.push({path: '/panel/sector/' + this.id});
                            }, 1000);
                        }
                    })
                    .catch((error) => {
