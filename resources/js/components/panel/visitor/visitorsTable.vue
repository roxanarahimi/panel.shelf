        ...
        <div class="card-body table-responsive">
            <table class="table">
                ...
                <tr :id="'row_'+data.id" v-for="(data, index) in allData" :key="data.id"
                    ...
                    <td>
                        <router-link :to="'/panel/visitor/'+data.id">{{ data.name }}</router-link>
                    </td>
                    <td>{{ data.mobile }}</td>
                    ...
                    <td>
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                            <li>
                                <router-link :to="'/panel/visitor/'+data.id" class="dropdown-item"
                                             style="text-align: right !important">
                                    مشاهده
                                </router-link>
                                <router-link :to="'/panel/edit/visitor/'+data.id"
                                             class="dropdown-item"
                                             style="text-align: right !important">
                                    ویرایش
                                </router-link>
