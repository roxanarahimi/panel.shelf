                            ...
                            <form id="editForm">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-4 mb-3">
                                        ...
                                        <select class="form-select" id="province_id" aria-describedby="provinceHelp"
    ...
    methods: {
        ...
        async createInfo() {
            ...
            if (emptyFieldsCount === 0) {
                await axios.post('/api/panel/city', {
                    ...
                    .then((response) => {
                        ...
                        if (response.status === 201 || response.status === 200) {
                            setTimeout(() => {
                                this.$router.push({path: '/panel/cities'});
                            }, 1000);
